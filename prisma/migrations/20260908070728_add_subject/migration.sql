...
INSERT INTO "new_QuestionSet" ("createdAt", "createdById", "description", "grade", "id", "isActive", "title", "updatedAt") SELECT "createdAt", "createdById", "description", "grade", "id", "isActive", "title", "updatedAt" FROM "QuestionSet";
